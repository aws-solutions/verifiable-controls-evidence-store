...
import RiskDeleteConfirmationModal from '.';

const riskName = 'Test risk';

describe('RiskDeleteConfirmationModal', () => {
    test('render', async () => {
        ...
        expect(getByText(`Delete ${riskName}`)).toBeVisible();
        expect(
            getByText(`Delete Risk ${riskName}? This action cannot be undone.`)
        ).toBeVisible();
