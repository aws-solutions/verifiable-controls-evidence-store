...
import EvidenceDetailView from '.';
...
describe('Evidence details page', () => {
    ...
    beforeAll(() => {
        ...
        when(mockUseAgsQueryfn)
            .calledWith(QueryType.GET_EVIDENCE, expect.any(String), undefined)
            .mockReturnValue({
                isLoading: false,
                data: evidenceData,
                isError: false,
        ...
        when(mockUseAgsQueryfn)
            .calledWith(QueryType.LIST_REVISIONS, expect.any(String))
            .mockReturnValue({
                data: undefined,
                isLoading: false,
            });
    ...
    test('render page', () => {
        ...
        expect(screen.getByText('Evidence Details - 1234')).toBeInTheDocument();
