...
import ApplicationDeleteConfirmationModal from '.';

const applicationName = 'Test Control objective';
const pipelineProvisionStatus = 'ACTIVE';

describe('ApplicationDeleteConfirmationModal', () => {
    test('render', async () => {
        ...
        const { getByText, getByPlaceholderText } = render(
            <ApplicationDeleteConfirmationModal
                ...
                pipelineProvisionStatus={pipelineProvisionStatus}
                visible={true}
                setVisible={mockOnSetVisible}
                onConfirmed={mockOnConfirmed}
            />
        );
        expect(getByText(`Delete ${applicationName}`)).toBeVisible();
        expect(
            getByText(
