...
import EnterpriseDeleteConfirmationModal from '.';

const enterpriseName = 'Test Enterprise';

describe('EnterpriseDeleteConfirmationModal', () => {
    test('render', async () => {
        ...
        expect(getByText(`Delete ${enterpriseName}`)).toBeVisible();
        expect(
            getByText(
