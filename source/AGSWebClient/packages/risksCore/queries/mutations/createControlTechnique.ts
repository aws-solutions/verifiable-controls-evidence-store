...
export class CreateControlTechniqueMutation extends MutationBase<
    CreateControlTechniqueParams,
    CreateControlTechniqueResponse
> {
    createRequest(
        request: CreateControlTechniqueParams
    ): AgsApiOptions<CreateControlTechniqueParams> {
        return {
    ...
    async onComplete(
        error: Error | null,
        data: CreateControlTechniqueResponse | null
    ): Promise<void> {
        if (error) {
